...
JSON_DIR = r'C:\Users\mmandziej001\Desktop\Projects\PWG\COMPANY_PERSON_PARSER\INPUT'


# In[25]:


OUTPUT_PATH = r'C:\Users\mmandziej001\Desktop\Projects\PWG\COMPANY_PERSON_PARSER\OUTPUT\\'
...
print(list(person_company_role.columns.values))
print(len(list(person_company_role.columns.values)))
print(len(columns_order_1))
